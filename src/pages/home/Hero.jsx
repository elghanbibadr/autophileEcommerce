...
const Hero = () => {
  return (
    <div  className=' lg:text-left   py-20   flex flex-col text-center justify-center  bg-hero-mobile  bg-bottom bg-cover xs:bg-center xs:bg-cover xs:h-screen lg:h-fit lg:py-40  xs2:bg-center  bg-no-repeat sm:bg-hero-tablet lg:bg-hero-desktop  '  >
