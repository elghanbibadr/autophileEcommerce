...
const ProductIntroCard = (props) => {
  return (
    <li className='bg-lightGray rounded-md relative h-40 flex my-10 justify-center  flex-col items-center w-full'>
        ...
        <div className='mt-20 text-center  uppercase'>
          ...
          <div className='flex  items-center justify-center mb-4'>
            <a className='text-lightGray text-[0.8rem] font-medium mr-2   '>shop</a>
